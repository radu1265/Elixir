defmodule Username do
  ...
  defp sanitize_helper(username, converted_username) do
    ...
    case head do
      ...
      ?ä -> sanitize_helper(tail, converted_username ++ 'ae')
      ?ö -> sanitize_helper(tail, converted_username ++ 'oe')
      ?ü -> sanitize_helper(tail, converted_username ++ 'ue')
      ?ß -> sanitize_helper(tail, converted_username ++ 'ss')
